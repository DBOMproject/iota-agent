...
describe('commitResource  with Jaeger', () => {
  let transactionStub;
  ...
  it('commitResource New Channel', async () => {
    ...
    const response = await iota.commitResource('testChannel', 'testResource', {}, 'CREATE', tracer, span);
  ...
  it('commitResource ReadOnly Channel', async () => {
    ...
    try {
      await iota.commitResource('testChannel', 'testResource', {}, 'CREATE', tracer, span);
  ...
  it('commitResource Attach', async () => {
    ...
    const response = await iota.commitResource('testChannel', 'testResource', {}, 'ATTACH', tracer, span);
    console.log('response');
    console.log(response);
    // eslint-disable-next-line no-unused-expressions
    expect(transactionStub.calledOnce).to.be.true;
  ...
  it('commitResource Attach ReadOnly Channel', async () => {
    ...
    try {
      await iota.commitResource('testChannel', 'testResource', {}, 'ATTACH', tracer, span);
      expect(false).to.equals(true);
    } catch (error) {
      // eslint-disable-next-line no-unused-expressions
      expect(assetDBChannelStub.calledOnce).to.be.true;
  ...
  it('commitResource Detach Failure', async () => {
    ...
    try {
      await iota.commitResource('testChannel', 'testResource', {}, 'DETACH', tracer, span);
      expect(false).to.equals(true);
    } catch (error) {
      // eslint-disable-next-line no-unused-expressions
      expect(assetDBChannelStub.calledOnce).to.be.true;
  ...
  it('commitResource Forbidden Channel', async () => {
    ...
    try {
      await iota.commitResource('_audit', 'testResource', {}, 'CREATE', tracer, span);
      expect(false).to.equals(true);
    } catch (error) {
  ...
  it('commitResource Update Missing Channel', async () => {
    ...
    try {
      await iota.commitResource('testChannel', 'testResource', {}, 'UPDATE', tracer, span);
      expect(false).to.equals(true);
    } catch (error) {
      // eslint-disable-next-line no-unused-expressions
      expect(assetDBChannelStub.calledOnce).to.be.true;
  ...
  it('commitResource Bad Type', async () => {
    ...
    try {
      await iota.commitResource('testChannel', 'testResource', {}, 'BAD', tracer, span);
      expect(false).to.equals(true);
    } catch (error) {
...
describe('queryResource with Jaeger', () => {
  let transactionStub;
  let assetDBChannelStub;
  let assetDBAssetStub;
  ...
  it('queryResource Existing', async () => {
    ...
    const response = await iota.queryResource('testChannel', 'testResource', tracer, span);
    console.log('response');
    console.log(response);
    // eslint-disable-next-line no-unused-expressions
    expect(transactionStub.calledOnce).to.be.true;
  ...
  it('queryResource Forbidden Channel', async () => {
    ...
    try {
      await iota.queryResource('_audit', 'testResource', tracer, span);
      expect(false).to.equals(true);
    } catch (error) {
      expect(error.message).to.equals('Forbidden Channel');
    }
  ...
  it('queryResource Missing Channel', async () => {
    ...
    try {
      await iota.queryResource('testChannel', 'testResource', tracer, span);
      expect(false).to.equals(true);
    } catch (error) {
      // eslint-disable-next-line no-unused-expressions
      expect(assetDBChannelStub.calledOnce).to.be.true;
...
describe('queryResourceAudit with Jaeger', () => {
  let transactionStub;
  let assetDBChannelStub;
  let assetDBAssetStub;
  ...
  it('queryResourceAudit Existing', async () => {
    ...
    const response = await iota.queryResourceAudit('testChannel', 'testResource', tracer, span);
    console.log('response');
    console.log(response);
    // eslint-disable-next-line no-unused-expressions
    expect(transactionStub.calledOnce).to.be.true;
  ...
  it('queryResourceAudit Existing Multiple Query Error', async () => {
    ...
    try {
      await iota.queryResourceAudit('testChannel', 'testResource', tracer, span);
      expect(false).to.equals(true);
    } catch (error) {
      // eslint-disable-next-line no-unused-expressions
      expect(transactionStub.calledTwice).to.be.true;
  ...
  it('queryResourceAudit Forbidden Channel', async () => {
    ...
    try {
      await iota.queryResourceAudit('_audit', 'testResource', tracer, span);
      expect(false).to.equals(true);
    } catch (error) {
      expect(error.message).to.equals('Forbidden Channel');
    }
