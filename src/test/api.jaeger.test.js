...
describe('Bad Params with Jaeger', () => {
  it('Bad Type', (done) => {
    chai
      .request(app)
...
describe('Create with Jaeger', () => {
  ...
  it('Create New', (done) => {
    ...
    chai
      ...
      .set('uber-trace-id', '0x04%3A0x05%3A0x01%3A0x01')
      .send({
        recordID: 'test',
        recordIDPayload: {
          test: 'test',
  ...
  it('Create Transaction Error', (done) => {
    const result = new Error('Error');
    transactionStub = sinon.stub(transaction, 'createMAMTransaction').rejects(result);
    // eslint-disable-next-line global-require
    chai
      .request(app)
      .post('/channels/test/records')
...
describe('Get with Jaeger', () => {
  ...
  it('Get transaction Error', (done) => {
    const result = new Error('Error');
    transactionStub = sinon.stub(transaction, 'getMAMTransaction').rejects(result);
    // eslint-disable-next-line global-require
    chai
      .request(app)
      .get('/channels/test/records/test')
...
describe('Audit with Jaeger', () => {
  ...
  it('Audit transaction Error', (done) => {
    const result = new Error('Error');
    transactionStub = sinon.stub(transaction, 'getMAMTransaction').rejects(result);
    // eslint-disable-next-line global-require
    chai
